...
df_prev = pd.read_csv( "../data/new_prevs.csv" ).fillna( 0.0)
df_bureau = pd.read_csv("../data/new_bureau.csv" ).fillna(0.0)
...
entity_id = "train" , dataframe = df_train  , index ="SK_ID_CURR" , variable_types = variable_types_train
)
...
r_2 = ft.Relationship( entity_train["train"]["SK_ID_CURR"] , entity_train["prev"]["SK_ID_CURR"] )

entity_train = entity_train.add_relationship(  r_1 ) 
entity_train = entity_train.add_relationship(  r_2 ) 
...
features.to_csv("../data/new_train_full.csv" )